  ...
  return (
    <div className="resume">
      <div className="resume-buttons-container">
        <FadeInModalButton title="Musician" content={text1} />
        <FadeInModalButton title="Software Engineer" content={"Teaching"} />
        <FadeInModalButton title="Teacher" content={"Software"} />
      </div>
    </div>
  )
}
