...
const Header = () => {
  return(
    <header className="header">
        <div className="title">
          <h1>Spencer Jones </h1>
          <h2>Musician, Software Engineer, & Educator</h2>
        </div>
  ...
  return (
    <div className="resume">
      <div className="resume-buttons-container">
        <FadeInModalButton title="Performer" content={text1} />
        <FadeInModalButton title="Teacher" content={"Teaching"} />
        <FadeInModalButton title="Engineer" content={"Software"} />
        <FadeInModalButton title="Education" content={"Education"} />
      </div>
    </div>
  )
}
